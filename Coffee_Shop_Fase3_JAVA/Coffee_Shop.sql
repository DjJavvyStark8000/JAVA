...
SELECT EF.ID_FACTURA,NOMBRE_CLIENTE,EF.ID_CLIENTE,FECHA,IMPUESTO,DESCUENTO,TOTAL FROM ENCABEZADO_FACTURA EF INNER JOIN CLIENTES C ON EF.ID_CLIENTE = C.ID_CLIENTE
