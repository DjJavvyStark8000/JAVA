...
public class Ent_EncabezadoFactura {
    ...
    public Ent_EncabezadoFactura(int id_encabezado, String nombre_cliente, int id_cliente, String fecha, BigDecimal impuesto, BigDecimal descuento, BigDecimal total) {
        this.id_encabezado = id_encabezado;
