 ...
 * @author djjav
 */
public class DiscountTotal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {         
            ...
            BigDecimal tax = Substracting.getTheTax();
            BigDecimal withTax = brute.add(tax);
            ...
            out.println(Substracting.getTheDiscount());
        } catch (Exception e) {
        }
    }
