 ...
 * @author djjav
 */
public class SaleSize extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        String selectedOption = request.getParameter("sizeProduct");
        ...
        out.println(Substracting.getProductSize() + " " + Substracting.getProductName());
    } catch (Exception e) {
       out.println("Error");
    }
}
