 ...
 * @author djjav
 */
public class LoadReceipts extends HttpServlet {
...
// Call the method to retrieve the list
            List<Ent_EncabezadoFactura> encabezadoFacturas = encabezadoLogic.callListarClienteEncabezado(Substracting.getTheCondition());
