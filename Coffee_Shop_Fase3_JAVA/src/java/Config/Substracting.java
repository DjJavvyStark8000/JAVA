...
public class Substracting {
    ...
    public static String getHalfCondition() {
        return halfCondition;
    }

    public static void setHalfCondition(String aHalfCondition) {
        halfCondition = aHalfCondition;
    }

    public static String getTheCondition() {
        return theCondition;
    }

    public static void setTheCondition(String aTheCondition) {
        theCondition = aTheCondition;
    }
    ...
    private static String halfCondition = "";
    private static String theCondition = "";
    private static int idReceipt = -1;
    ...
    public static ArrayList<Object[]> receiptLines = new ArrayList<Object[]>();
    public static List<Object[]> productSubtractDetails = new ArrayList<>();
    public static ArrayList<Object[]> clientReceipts = new ArrayList<Object[]>();
    ...
    public static boolean getIsReseting(){
    return isResetting;
    }
    
    public static void setIsReseting(Boolean isReseting){
        Substracting.isResetting = isReseting;
    }
    ...
    public static void setIdReceipt(int idReceipt) {
        Substracting.idReceipt = idReceipt;
    }
    ...
    //add or uptade table
    public static void addOrUpdateRow(Object[] newRowData) {
    ...
    public static void productSubstractQuantities() {
        ...
        BigDecimal strawQuantity = BigDecimal.ZERO;
        ...
        if (Substracting.getCupSize().equals(new BigDecimal("12.00"))) {
            ...
            strawQuantity = Substracting.getOrderQuantity();
        }
        ...
        Object[] addSubtractingProducts = {BL_Accounting.getId_coffee(), Substracting.getCupSize(), BL_Accounting.getId_straw(),
            strawQuantity, BL_Accounting.getId_small_cup(), cupSmallAmount, BL_Accounting.getId_medium_cup(),
            ...
            BL_Accounting.getId_milk(), Substracting.getMilkQuantity()};
        //add to array list
